module.exports = [
  ...
  {      name: "wants_pizza",      type: "confirm",      message: "Do you want a free pizza?",    },
...
{      name: "confirm_answer",      type: "confirm",      message: "Are you sure?",      when: (answers) => answers.template === 'dcloudio/hello-uniapp',    },
{
